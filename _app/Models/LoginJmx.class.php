...
class LoginJmx {
    ...
    private function setLogin() {
        if (!$this->Email || !$this->Senha || !Check::Email($this->Email)):
            $this->Error = ['Informe seu E-mail e senha para efetuar o login!', JMX_INFO];
            $this->Result = false;
        elseif (!$this->getUser()):
    ...
    private function getUser() {
        ...
        $read = new Read;
        $read->readDb("jm_jmx", "WHERE user_email = :e AND user_password = :p", "e={$this->Email}&p={$this->Senha}");
