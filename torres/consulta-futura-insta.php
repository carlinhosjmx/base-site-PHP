...
?>
   ...
   <header>
   	<h1>Multas Variadas</h1>
            <h2>Datas futuras a consultar </h2>
        </header>
...
<?php
           ...
           $lista = new Read;
          $lista->readDb("jm_clientes","inner join jm_servicos on jm_clientes.id_cliente = jm_servicos.id_cliente WHERE data_consulta > {$data}  and servico = '1' ");
          ...
          echo "<h2 class='display'>Não há pesquisas futuras!</h2>";
            endif;
