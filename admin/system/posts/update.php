...
<div class="box-adm">
    ...
    <article>
        ...
        if (isset($post) && $post['SendPostForm']):
            ...
            $read = new Read;
            $read->readDb("jm_posts", "INNER JOIN jm_sub_category ON  id_sub_category = post_category WHERE post_id = :id", "id={$postid}");
        ...
        <form name="PostForm" action="" method="post" enctype="multipart/form-data">
            ...
            <label>
                ...
                <label>
                    ...
                    <input type="text"  class="form-control" name="" readonly="readonly" value="<?php if (isset($post['sub_category_tags'])) echo $post['sub_category_tags']; ?>" />
