...
class AdminSubCategory {
    ...
    private function setData() {
        ...
        $this->Data['category_parent'] =   $this->Data['categorie_id'];
        $this->Data['category_name'] = Check::urlFormat($this->Data['category_name']);
        $this->Data['category_title'] =   $this->Data['category_name'];
        $this->Data['category_content'] =   $this->Data['category_content'];
        $this->Data['category_date'] = Check::formatData($this->Data['category_date']);

        unset( $this->Data['categorie_id']);
    ...
    private function cadastra() {
        ...
        if ( $Insert ->getResult()):
            ...
            $this->Error = ["<div class='sucess'><b>Sucesso:</b> A Subcategoria {$this->Data['category_name']} foi cadastrada no sistema!</div>", JMX_ACCEPT];
    ...
    private function Update() {
        ...
        if ($Update->getResult()):
            ...
            $this->Result = true;
            $this->Error = ["<div class='sucess'><b>Sucesso:</b> A {$tipo} {$this->Data['category_name']} foi atualizada no sistema!</div>", JMX_ACCEPT];
        endif;
    }
