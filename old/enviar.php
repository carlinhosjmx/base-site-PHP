...
$nome = $_POST['nome_ct'];
$cidade = $_POST['cidade_ct'];
$email = $_POST['email_ct'];
$telefone = $_POST['fone_ct'];
$msg = $_POST['obs'];
$arquivo = $_FILES["arquivo"];

 // aqui vai o email que irá receber os valores

$to = "carlinhosx7@hotmail.com";
...
<script language="JavaScript">alert('Preencha os campos Nome, e-mail e Telefone antes de enviar!');
...
$assunto = "Mensagem do site Partituras Musicais: ".$nome." em: ".date("d/m/Y - H:i",time()+0*3600);
...
$arquivo = isset($_FILES["arquivo"]) ? $_FILES["arquivo"] : FALSE;
	...
	$mens .= "<strong>Nome: </strong> $nome <br> <br><strong>Email: </strong> $email <br><br><strong>Telefone: </strong> $telefone <br><br><strong>Cidade: </strong> $cidade <br> <br><strong>Data: </strong> $data <br><br> <strong>Mensagem:</strong> $msg\r\n";
