...
<div id="labeltable"><div id="coluna1">Música</div><div id="coluna2">Instrumento</div><div id="coluna3">Artista</div><div id="coluna5">Tipo</div><div id="coluna4">Enviada Por</div></div><!--labeltable-->
...
<?php
   ...
   include_once "content_musica.php";
