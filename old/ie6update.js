...
(function($) {
    ...
    $.fn.activebar.defaults = {
        ...
        'fontSize': '14px',
        'icons_path' : 'images/',
        'url': 'http://www.microsoft.com/pt-br/download/internet-explorer-9-details.aspx',
        'preload': true
    };
...
jQuery(document).ready(function($) {
  $('<div></div>').html(IE6UPDATE_OPTIONS.message || 'Seu navegador é uma versão muito antiga do Internet Explorer  e talvez não visualize corretamente esse site. Clique aqui para fazer o download da versão mais nova, Internet explorer 9... Ou vizualize no Navegador Chrome ou Firefox! ')
