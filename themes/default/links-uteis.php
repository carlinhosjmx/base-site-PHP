             	 ...
             	 if( $readCat->getResult()[0]['post_order'] == '1'):
             	  ...
             	  foreach($readCat->getResult() as $serv):
                      ...
                      if( $serv['post_order'] == '2'):
				              ...
				              echo '<div class="box-links1"><h2>'.$serv['post_title'].'  </h2>
                        ...
                        if( $serv['post_order'] == '3'):
				              ...
				              echo '<div class="box-links2"><h2>'.$serv['post_title'].'  </h2>

				                     <div class="inter-box"> <p>'.$serv['post_content'].'</p></div></div><div class="clear"></div>';
